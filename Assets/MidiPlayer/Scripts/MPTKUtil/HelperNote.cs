...
namespace MidiPlayerTK
{
    ...
    public class HelperNoteLabel
    {
        ...
        public static float _ratioHalfTone = 0.0594630943592952645618252949463f;
        public string Drum = "";
        public bool IsNoteC;
        public string Label;
        public int Midi;
        ...
        {
            Debug.LogWarning(
                "Maestro 2.12.2 - LabelC4FromMidi is deprecated and will be removed. Please consider using LabelFromMidi");
        ...
        ///     Notes recorded on channel 10/17 always produce percussion sounds. Each distinct note number specifies a unique
        ///     percussive instrument, rather than the sound's pitch.\n
        ///     https://en.wikipedia.org/wiki/General_MIDI\n
        /// </summary>
        /// <param name="midiValue">
        ///     Note value between 27 (D2#) and 87 (D7#) return the label of a percussive instrument else
    ...
    public class HelperNoteRatio
    {
        ...
        public static float _ratioHalfTone = 1.0594630943592952645618252949463f;
        public static float _rationCents = 1.0005777895f;
        public int Delta;
        public float Ratio;
        ...
        /// <returns></returns>
        public static float Get(int delta, int finetune)
        {
            try
            {
                return Mathf.Pow(_ratioHalfTone, delta + finetune / 100f);
            }
            catch (Exception ex)
            {
        ...
        public static void Init()
        {
            try
            {
                ...
                for (var index = 0; index < 120; index++) Ratios[index] = Mathf.Pow(_ratioHalfTone, index - 60);
            }
            catch (Exception ex)
            {
                MidiPlayerGlobal.ErrorDetail(ex);
