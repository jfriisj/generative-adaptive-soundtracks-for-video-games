    ...
    public class MidiStreamPlayerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            try
            {
                ...
                commonEditor.DrawCaption(instance, "Midi Stream Player - Create your music with your algo.",
                    "https://paxstellar.fr/midi-file-player-detailed-view-2-2/",
                    "d9/d1e/class_midi_player_t_k_1_1_midi_stream_player.html#details");
