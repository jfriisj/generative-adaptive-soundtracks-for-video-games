...
namespace MidiPlayerTK
{
    ...
    public class MenuShortcut : EditorWindow
    {
        ...
        private static void CreateMidiFilePlayerGameObject(MenuCommand menuCommand)
        {
        ...
        private static void CreateMidiStreamPlayerGameObject(MenuCommand menuCommand)
        {
        ...
        private static void CreateMidiFileLoaderGameObject(MenuCommand menuCommand)
        {
            // Deprecated with 2.10.1 - CreatePrefab(menuCommand, "MidiFileLoader", "Assets/MidiPlayer/Prefab/MidiFileLoader.prefab");
            Debug.LogWarning(
                "Maestro 2.10.1 - MidiFileLoader prefab is deprecated and will be removed. Please consider using MidiFilePlayer");
        ...
        private static void CreateMidiExternalPlayGameObject(MenuCommand menuCommand)
        {
        ...
        private static void CreateMidiInReaderGameObject(MenuCommand menuCommand)
        {
        ...
        private static void CreateMidiListPlayerGameObject(MenuCommand menuCommand)
        {
        ...
        private static void CreateMidiSpatializerGameObject(MenuCommand menuCommand)
        {
            CreatePrefab(menuCommand, "MidiSpatializer", "Assets/MidiPlayer/Prefab/Pro/MidiSpatializer.prefab");
        }

        private static void CreatePrefab(MenuCommand menuCommand, string prefabName, string prefabPath)
        {
