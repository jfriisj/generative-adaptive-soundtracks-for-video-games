    ...
    public class MidiFilePlayerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            try
            {
                ...
                commonEditor.DrawCaption(instance, "Midi File Player - Play MIDI from the internal MIDI DB.",
                    "https://paxstellar.fr/midi-file-player-detailed-view-2/",
                    "d7/deb/class_midi_player_t_k_1_1_midi_file_player.html#details");

                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField(new GUIContent("Select MIDI ", "Select Midi File to play"),
                    GUILayout.Width(150));
                    ...
                    MidiPlayerGlobal.CurrentMidiSet.MidiFiles.Count > 0)
                {
                    if (GUILayout.Button(
                            new GUIContent(instance.MPTK_MidiIndex + " - " + instance.MPTK_MidiName,
                                "Selected MIDI File to play"), GUILayout.Height(30)))
                ...
                instance.showEvents = MidiCommonEditor.DrawFoldoutAndHelp(instance.showEvents, "Show Unity Events",
                    "https://paxstellar.fr/midi-file-player-detailed-view-2/#Foldout-Events");
