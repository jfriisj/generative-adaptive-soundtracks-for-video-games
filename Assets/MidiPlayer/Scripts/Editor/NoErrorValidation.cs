...
{
    [InitializeOnLoad]
    internal class NoErrorValidator
    {
        public static bool CantChangeAudioConfiguration;
        ...
        private static void CompileFinish(string s, CompilerMessage[] compilerMessages)
        {
            Debug.Log($"Compilation {s} Finished, error: " +
                      compilerMessages.Count(m => m.type == CompilerMessageType.Error));
