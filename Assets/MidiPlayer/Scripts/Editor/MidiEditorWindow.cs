...
namespace MidiPlayerTK
{
    ...
    ///     Investigate why midiPlayerGlobal.InitInstance() takes time occasionally: sometime Unity take more time to load the
    ///     samples. Nothing can be done.
    ///     Hide/show channel
    ...
    {
        private static MidiEditorWindow window;
