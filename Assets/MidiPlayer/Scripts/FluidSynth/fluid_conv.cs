...
namespace MidiPlayerTK
{
    public class fluid_conv
    {
         ...
         */
        public static float FLUID_PEAK_ATTENUATION = 960.0f;
        ...
        public static void fluid_conversion_config()
        {
            ...
            */
            ...
            for (i = 1; i < FLUID_VEL_CB_SIZE - 1; i++)
            {
                ...
                // MPTK 2.11.3
                x = -200f * 2f / FLUID_PEAK_ATTENUATION * Mathf.Log(i / (FLUID_VEL_CB_SIZE - 1f)) / M_LN10;
        ...
        {
            if (cents < 0) return fluid_act2hz(cents);

            int mult, fac, rem;
            var icents = (int)cents;
            icents += 300;
