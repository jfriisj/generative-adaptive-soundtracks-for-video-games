namespace MidiPlayerTK
{
    ...
    public enum fluid_gen_type : byte
    {
        ...
        /**
         * < Sample loop start address offset
         * (
         * -
         * 3
         * 2
        ...
        /**
         * < Sample loop end address offset
         * (
         * -
         * 3
         * 2
        ...
        /**
         * < Sample start address coarse offset ( X
         * 3
         * 2
         * 7
         * 6
        ...
        /**
         * < Sample end address coarse offset ( X
         * 3
         * 2
         * 7
         * 6
        ...
        /**
         * < Sample start loop address coarse offset ( X
         * 3
         * 2
         * 7
         * 6
        ...
        /**
         * < Sample end loop address coarse offset ( X
         * 3
         * 2
         * 7
         * 6
         ...
         *     a note on note-on event. By nature it
         *     shouldn't be allowed to be modulated,
    ...
    public class HiGenAmount
    {
        ...
        public byte Hi
        {
            get => (byte)((Uword & 0xFF00) >> 8);
            set
            {
                Uword &= 0x00FF;
                Uword += (ushort)(value << 8);
            }
        }
    }
    ...
    public class HiGen
    {
        ...
        public static void fluid_gen_init(HiGen[] gens, MPTKChannel channel)
        {
