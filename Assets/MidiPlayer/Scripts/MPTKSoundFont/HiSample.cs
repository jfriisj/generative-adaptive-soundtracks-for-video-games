namespace MidiPlayerTK
{
    ...
    public class HiSample // : ISerializable
    {
        ...
        ///     This value is used as the default �root key� for the sample, so that in the example, a MIDI key-on command for note
        ///     number 60 would reproduce the sound at its original pitch.
