...
namespace MidiPlayerTK
{
    ...
    public enum MPTKCommand : byte
    {
        ...
        ///     The default sensitivity value is 2. That means that the maximum pitch bend will result in a pitch change of two
        ///     semitones\n
        ...
        ///     In MPTKEvent the attibute MPTKEvent#Meta defined the type of meta event. See #MPTKMeta (TextEvent, Lyric,
        ///     TimeSignature, ...).\n
        ///     - if MPTKEvent#Meta = #MPTKMeta.SetTempo, MPTKEvent#Value contains new Microseconds Per Beat Note. . Please
        ///     investigate MPTKEvent.QuarterPerMicroSecond2BeatPerMinute() to convert to BPM.
        ///     - if MPTKEvent#Meta = #MPTKMeta.TimeSignature, MPTKEvent#Value contains four bytes. From less significant to most
        ///     significant. Please investigate MPTKEvent.ExtractFromInt().
        ...
        ///     - if MPTKEvent#Meta = #MPTKMeta.KeySignature, MPTKEvent#Value contains two bytes. From less significant to most
        ///     significant. Please investigate MPTKEvent.ExtractFromInt().
    ...
    ///     Each MIDI CC operates at 7-bit resolution, meaning it has 128 possible values. The values start at 0 and go to
    ///     127.\n
    ///     Some instruments can receive higher resolution data for their MIDI control assignments. These high res assignments
    ///     are defined by combining two separate CCs,\n
    ...
    ///     First you need to tell the synthesizer what parameter you want to change, then you need to tell it how to change
    ///     the parameter. \n
    ///     For example, if you want to change the "pitch bend sensitivity" to 12 semitones, you would send the following
    ///     controler midi message:\n
    ...
    public enum MPTKMeta : byte
    {
        ...
        ///     @deprecated MPTKEvent.Value content with version 2.10.0 - Now MPTKEvent.Duration no longer contains tempo in
        ///     quarter per minute. Please investigate MPTKEvent.QuarterPerMicroSecond2BeatPerMinute()
        /// </summary>
        SetTempo = 0x51,
        ...
        ///     MPTKEvent.Value contains four bytes. From less significant to most significant. Please investigate
        ///     MPTKEvent.ExtractFromInt():
        ///     -# Numerator (number of beats in a bar),
        ///     -# Denominator (Beat unit: 1 means 2, 2 means 4 (crochet), 3 means 8 (quaver), 4 means 16, ...)
        ///     -# TicksInMetronomeClick, generally 24 (number of 1/32nds of a note happen by MIDI quarter note)
        ///     -# No32ndNotesInQuarterNote, generally 8 (standard MIDI clock ticks every 24 times every quarter note)
        ///     @deprecated MPTKEvent.Value content with version 2.10.0 - Now MPTKEvent.Value no longer contains the numerator and
        ///     MPTKEvent.Duration the Denominator (all values are merged in MPTKEvent::Value
        /// </summary>
        TimeSignature = 0x58,

        /// <summary>
        ///     @brief Key signature
        ///     MPTKEvent.Value contains two bytes. From less significant to most significant. Please investigate
        ///     MPTKEvent.ExtractFromInt().
        ///     -# SharpsFlats (number of sharp)
        ///     -# MajorMinor flag (0 the scale is major, 1 the scale is minor).
