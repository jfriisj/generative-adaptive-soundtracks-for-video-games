...
{
    /// <summary>
    ///     Description of a MIDI Event. It's the heart of MPTK! Essential to handling MIDI by script from all others classes
    ///     as MidiStreamPlayer, MidiFilePlayer, MidiFileLoader, MidiFileWriter2 ...\n
    ///     The MPTKEvent main property is MPTKEvent.Command, the content and role of other properties (as MPTKEvent.Value)
    ///     depend on the value of MPTKEvent.Command. Look at the MPTKEvent.Value property.\n
    ///     With this class, you can: play and stop a note, change instrument (preset, patch, ...), change some control as
    ///     modulation (Pro) ...\n
    ///     Use this class in relation with these classes:
    ///     - MidiFileLoader     to read MIDI events from a MIDI file.\n
    ///     - MidiFilePlayer     process MIDI events, thank to the class event OnEventNotesMidi when MIDI events are played
    ///     from the internal MIDI sequencer.\n
    ...
    ///     See here https://paxstellar.fr/class-mptkevent and here
    ...
    ///     MidiStreamPlayer midiStreamPlayer = FindFirstObjectByType
    ///     <MidiStreamPlayer>
    ///         ();
    ...
    ///         Channel = 0 }; // Instrument are defined by channel (from 0 to 15). So at any time, only 16 diff�rents
    ...
    public class MPTKEvent : ICloneable
    {
        ...
        /// <summary>
        ///     @brief
        ///     V2.9.0 Time from System.DateTime when the Event has been created (in the constructor of this class). Divide by
        ...
        ///     - TimeSignature: no longer contains the Denominator (Beat unit: 1 means 2, 2 means 4 (crochet), 3 means 8 (quaver),
        ///     4 means 16, ...)\n
        ...
        ///     MPTK_ClearAllSound is able to clear (note off) only the voices associated with this MIDI file when switching
        ///     MIDI.\n
        ///     Switching between MIDI playing is very quick.\n
        ///     Could also be used for other prefab like MidiStreamPlayer for your specific need, but avoid changing this
        ///     properties with MidiFilePlayer.
        /// </summary>
        ...
        /// <summary>
        ///     @brief
        ///     Measure (bar) when this event will be played. Measure is calculated with the Time Signature event when a MIDI file
        ///     is loaded.\n
        ///     By default the time signature is 4/4.
        /// </summary>
        public int Measure;
        ...
        /// <summary>
        ///     @brief
        ///     Real time in milliseconds of this MIDI Event from the start of the MIDI. It take into account the tempo changes but
        ///     not MidiFilePlayer.MPTK_Speed \n
        ///     v2.89.6 Correct the time shift when a tempo change is read. Thanks to Ken Scott http://www.youtube.com/vjchaotic
        ///     for the tip.\n
        ...
        ///     This time is independent of the Tempo or Speed. Not used for MidiStreamPlayer nor MidiInReader because they are
        ///     real-time player.
        /// </summary>
        public long Tick;
        ...
        ///                 !
        ///                 <li>
        ///                     #Value contains MIDI note as defined in the MIDI standard and matched to the Middle C (note number
        ///                     60) as C4.\n
        ///                     !         look here:
        ...
        ///                 !
        ///                 <li>
        ///                     #Value contains patch/preset/instrument value. See the current SoundFont to find value associated
        ///                     to each instrument.\n
        ///                     !                If your SoundFont follows the General MIDI (GM) map, instrument Patch map will be
        ///                     like ths one:\n
        ...
        ///         !
        ///         <li>
        ///             #Command = #MPTKCommand.MetaEvent and #Meta equal:
        ///             !
        ///             <ul>
        ...
        /// <summary>
        ///     @brief
        ///     List of voices associated to a NoteOn Event. This is a list because it is common for several samples to be used
        ///     simultaneously to play a note.
        /// </summary>
        ...
        public MPTKEvent(ulong data)
        {
            ...
            var data1 = (byte)((data >> 40) & 0xff);
            var data2 = (byte)((data >> 48) & 0xff);
        ...
        /// </summary>
        public long LatenceTime => DateTime.UtcNow.Ticks - CreateTime;
        ...
        ///     @note Disabled by default. Defined DEBUG_PERF_AUDIO in MidiSynth to activate for debug purpose only.
        /// </summary>
        public long LatenceTimeMillis => LatenceTime / fluid_voice.Nano100ToMilli;
        ...
        public ulong ToData()
        {
            var data = (ulong)Command | ((ulong)Channel & 0xF);
            switch (Command)
            {
                case MPTKCommand.NoteOn:
        ...
        ///     With BPM=1,   microsecondsPerQuaterNote=60 000 000 �s ->  60 secondes per quarter (quite slow!)\n
        ///     With BPM=120, microsecondsPerQuaterNote=500?000 �s -> 0.5 seconde per quarter\n
        /// </summary>
        /// <param name="bpm">Beats Per Minute (with assumption beat=quarter)</param>
        /// <returns>
        ///     60000000 / bpm or 500000 if bpm <= 0</returns>
        ...
        ///     With microsecondsPerQuaterNote=500?000 �s, BPM = 120
        /// </summary>
        /// <param name="microsecondsPerQuaterNote"></param>
        /// <returns>
        ///     60000000 / bpm or 120 if microsecondsPerQuaterNote <= 0</returns>
        ...
        ///     (b4 << 24) | (b3 << 16) | (b2 << 8) | b1
        /// </returns>
        public static int BuildIntFromBytes(byte b1, byte b2, byte b3, byte b4)
        {
        ...
        public static byte ExtractFromInt(uint v, int n)
        {
        ...
        ///     For a better result when displayed on the console (Debug.Log), enable "Monospace font" in the setting of the
        ///     console (three vertical dot in the panel)
        /// </summary>
        /// <returns></returns>
        public string ConvertToString(bool brief)
        {
            ...
            switch (Command)
            {
                ...
                case MPTKCommand.MetaEvent:
                    ...
                    {
                        command = $"{Meta} error value:{Value}";
                    }
            ...
            if (!brief)
            {
                ...
                if (Command == MPTKCommand.NoteOn || Command == MPTKCommand.NoteOff ||
                    Command == MPTKCommand.KeyAfterTouch || Command == MPTKCommand.ControlChange ||
                    Command == MPTKCommand.PatchChange || Command == MPTKCommand.ChannelAfterTouch ||
            ...
            else if (Command == MPTKCommand.NoteOn || Command == MPTKCommand.NoteOff ||
                     Command == MPTKCommand.KeyAfterTouch || Command == MPTKCommand.ControlChange ||
                     Command == MPTKCommand.PatchChange || Command == MPTKCommand.ChannelAfterTouch ||
                     Command == MPTKCommand.PitchWheelChange)
            {
            ...
            switch (Command)
            {
                case MPTKCommand.NoteOn:
                    ...
                    var strNote = brief ? "" : $"/{HelperNoteLabel.LabelFromMidi(Value)}";
                    ...
                    try
                    {
                        switch (Meta)
                        {
                            case MPTKMeta.KeySignature:
                                result =
                                    $"{command} SharpsFlats:{ExtractFromInt((uint)Value, 0)} MajorMinor:{ExtractFromInt((uint)Value, 1)}";
                                break;
                            case MPTKMeta.TimeSignature:
                                result =
                                    $"{command} Numerator:{ExtractFromInt((uint)Value, 0)} Denominator:{ExtractFromInt((uint)Value, 1)}";
                                break;
                            case MPTKMeta.SetTempo:
                                result = $"{command} Microseconds:{Value} Tempo:{60000000 / Value:F2}"; break;
                            default:
                                var sinfo = Info ?? "";
                                result = $"{command} {sinfo}";
                                break;
                        }
                    }
                    catch
                    {
                        result = $"{command} {Meta} error value:{Value}";
                    }
        ...
        {
            var tickComparison = Tick.CompareTo(y.Tick);
            ...
            if (tickComparison == 0)
            {
                ...
                int GetTypePriority(MPTKEvent midi)
                {
                    return midi.Command switch
                    {
