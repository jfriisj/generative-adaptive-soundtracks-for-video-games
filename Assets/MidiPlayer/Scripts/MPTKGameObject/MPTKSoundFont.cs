...
namespace MidiPlayerTK
{
    ...
    ///     Additionally, Maestro MPTK supports assigning different SoundFonts to different MIDI players, enabling flexible and
    ///     customized audio rendering across multiple instruments or scenes.\n
    ///     @version 2.14
    ///     @note
    ///     - An instance of this class is automatically created for each MPTK prefab (MidiFilePlayer, MidiStreamPlayer ...)
    ///     loaded in the scene. see MidiSynth.MPTK_SoundFont
    ///     - To get logs when running set MidiFilePlayer.VerboseSoundfont to true.
    /// </summary>
    public class MPTKSoundFont
    {
        ...
        ///     - Interesting only for external soundfont, useful to download a SoundFont in the background and load it later in
        ///     many MidiSynths.
        /// </summary>
        ...
        private readonly ImSoundFont sfLocal = null;
        private readonly string soundFontName = string.Empty;
        ...
        /// <summary>
        ///     @brief
        ///     True if the Soundfont is loaded from the MPTK resources (internal)  and is the default (selected in "Soundfont
        ///     Setup").
        /// </summary>
        ...
        /// </summary>
        public bool IsReady => SoundFont != null;
        ...
        /// <summary>
        ///     @brief
        ///     List of banks name available with the format "
        ///     <number>
        ///         - Bank". Unlike preset, there is no bank name defined in a Soundfont.\n
        ///         Index in the list is not the bank number (missing bank have been removed), use the same index in #BanksNumber
        ///         to get the bank number.
        /// </summary>
        public List<string> BanksName => sfLocal != null ? banksName : MidiPlayerGlobal.MPTK_BanksName;

        /// <summary>
        ///     @brief
        ///     List of banks number available.
        ///     Index in the list is not the bank number (missing banks have been removed), use the same index in #BanksName to get
        ///     the bank name.
        /// </summary>
        public List<int> BanksNumber => sfLocal != null ? banksNumber : MidiPlayerGlobal.MPTK_BanksNumber;


        /// <summary>
        ///     @brief
        ///     List of preset name available with the format "
        ///     <number>
        ///         -
        ///         <name>
        ///             ".\n
        ///             Index in the list is not the preset number (preset missing has been removed), use the same index in
        ///             #PresetsNumber to get the preset number.
        /// </summary>
        public List<string> PresetsName => sfLocal != null ? presetsName : MidiPlayerGlobal.MPTK_PresetsName;
        ...
        /// </summary>
        public List<int> PresetsNumber => sfLocal != null ? presetsNumber : MidiPlayerGlobal.MPTK_PresetsNumber;
        ...
        ///         -
        ///         <name>
        ///             " but dedicated to drum bank.\n
        ///             Index in the list is not the preset number (preset missing has been removed), use the same index in
        ///             #PresetsDrumNumber to get the preset number.
        /// </summary>
        public List<string> PresetsDrumName => sfLocal != null ? presetsDrumName : MidiPlayerGlobal.MPTK_PresetsName;
        ...
        /// </summary>
        public List<int> PresetsDrumNumber => sfLocal != null ? presetsDrumNumber : MidiPlayerGlobal.MPTK_PresetsNumber;

        /// <summary>
        ///     @brief
        ///     Get the list of banks available. It's a full and fixed list of 129 MPTKListItem with null value if a bank is
        ///     missing.\n
        ///     MPTKListItem.Index give the number of the bank\n
        ///     Prefer using the #BanksName to get a list of bank available and #BanksNumber to get the bank number at same
        ///     corresponding index.\n
        ///     @note
        ...
        /// <summary>
        ///     @brief
        ///     List of presets for instrument for the default or selected bank. When using with preset change MIDI event,
        ...
        /// <summary>
        ///     @brief
        ///     List of presets drum for the default or selected bank. When using with preset change MIDI event, MPTKListItem.Index
        ///     give the number of the preset\n
        ///     @note
