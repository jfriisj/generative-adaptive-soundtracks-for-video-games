...
namespace MidiPlayerTK
{
    ...
    public class MidiPlayerGlobal : MonoBehaviour
    {
        ...
        public const string ErrorNoSoundFont =
            "No global SoundFont ready found. Load and choose a SoundFont from the Unity Editor menu 'Maestro/SoundFont Setup'";

        public const string ErrorNoPreset =
            "No Preset found in the SoundFont selected.\nHave you extracted them?\nCheck from the Unity Editor menu 'Maestro/SoundFont Setup'";

        public const string ErrorNoMidiFile =
            "No MIDI found in MIDI DB. Add MIDI file from Unity Editor menu 'Maestro/MIDI File Setup' or copy .mid files in MidiPlayer/Resources/MidiDB folder and load all with 'Maestro/MIDI File Setup'.";
        ...
        ///     @version 2.15.0
        /// </summary>
        public static string MPTK_SoundFontName;
        ...
        /// <summary>
        ///     @brief
        ///     Loading status for SoundFont from external file or URL. For status from local resources folder use
        ...
        ///     The default bank can be changed with #MPTK_SelectBankInstrument or with the popup "SoundFont Setup Alt-F" in the
        ///     Unity editor.
        /// </summary>
        ...
        ///     The default bank can be changed with #MPTK_SelectBankInstrument or #MPTK_SelectBankDrum or with the menu "MPTK /
        ///     SoundFont" or Alt-F in the Unity editor.
        /// </summary>
        ...
        ///     The default bank can be changed with #MPTK_SelectBankDrum or with the menu "MPTK / SoundFont" or Alt-F in the Unity
        ///     editor.
        /// </summary>
        public static List<MPTKListItem> MPTK_ListPresetDrum;


        [HideInInspector] public string PathToResources;
        ...
        /// </summary>
        public UnityEvent InstanceOnEventPresetLoaded = new();
        ...
        public static MidiPlayerGlobal Instance { get; private set; }

        /// <summary>
        ///     @brief
        ///     This path could change depending your project. Change the path before any actions in MPTK.
        /// </summary>
        public static string MPTK_PathToResources //= "MPTK/Resources/";
        {
            get
            {
                string path;
        ...
        ///     @version 2.11.2 Pro
        /// </summary>
        public static string MPTK_PathSoundFontCache => Path.Combine(Application.persistentDataPath, "DownloadedSF");
        ...
        /// </summary>
        public static TimeSpan MPTK_TimeToDownloadSoundFont => timeToDownloadSoundFont;

        /// <summary>
        ///     @brief
        ///     Loading time for the current SoundFont
        /// </summary>
        public static TimeSpan MPTK_TimeToLoadSoundFont => timeToLoadSoundFont;

        /// <summary>
        ///     @brief
        ///     Loading time for the samples
        /// </summary>
        public static TimeSpan MPTK_TimeToLoadWave => timeToLoadWave;
        ...
        public static bool MPTK_SoundFontIsReady =>
            ImSFCurrent != null &&
            CurrentMidiSet != null &&
            CurrentMidiSet.ActiveSounFontInfo != null &&
            CurrentMidiSet.ActiveSounFontInfo.PatchCount > 0;
        ...
        {
            get => Instance != null ? Instance.LoadSoundFontAtStartup : false;
            set
            {
                if (Instance != null)
        ...
        {
            get => Instance != null ? Instance.LoadWaveAtStartup : false;
            set
            {
                if (Instance != null)
        ...
        {
            get => Instance != null ? Instance.verboseGlobal : false;
            set
            {
                if (Instance != null) Instance.verboseGlobal = value;
            }
        }
        ...
        ///     Setting this callback function by script (AddListener) is not recommended. It's better to set callback function
        ///     from the inspector.
        ///     See
        ///     here:https://mptkapi.paxstellar.com/d7/dc4/class_midi_player_t_k_1_1_midi_player_global.html#a64995b20027b35286c143f9f25a1cb6d
        ///     @image html OnEventGlobal.png
        /// </summary>
        public static UnityEvent OnEventPresetLoaded
        {
            get => Instance != null ? Instance.InstanceOnEventPresetLoaded : null;
        ...
        /// <summary>
        ///     @brief
        ///     List of Soundfont(s) available. With the MPTK PRO, add or remove SoundFonts from the Unity editor menu "MPTK /
        ///     SoundFont Setup" or Alt-F
        /// </summary>
        public static List<string> MPTK_ListSoundFont
        {
            get
            {
                if (CurrentMidiSet != null && CurrentMidiSet.SoundFonts != null)
                {
                    ...
                    foreach (var sfi in CurrentMidiSet.SoundFonts)
        ...
        /// <summary>
        ///     @brief
        ///     Find index of a Midi by name. Use the exact name defined in Unity resources folder MidiDB without any path or
        ///     extension.\n
        ///     Tips: Add Midi files to your project with the Unity menu MPTK or add it directly in the ressource folder and open
        ///     Midi File Setup to automatically integrate Midi in MPTK.
        /// </summary>
        ...
        public static float MPTK_DistanceToListener(Transform trf)
        {
            ...
            try
            {
                if (AudioListener != null) distance = Vector3.Distance(AudioListener.transform.position, trf.position);
        ...
        {
            if (verboseGlobal) startInstance = DateTime.Now;
        ...
        {
            if (MPTK_ListPreset != null && patch >= 0 && patch < MPTK_ListPreset.Count &&
                MPTK_ListPreset[patch] != null)
            ...
            if (!Initialized)
            {
                ...
                try
                {
                    ...
                    if (AudioListener == null)
                        Debug.LogWarning(
                            "No audio listener found. Add one and only one AudioListener component to your hierarchy.");
                    //return;
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    if (verboseGlobal)
                        Debug.Log(
                            $"{(DateTime.Now - startInstance).TotalSeconds:F3} MidiPlayerGlobal - LoadMidiSetFromRsc");

                    DicAudioWave.Init();
                    if (verboseGlobal)
                        Debug.Log(
                            $"{(DateTime.Now - startInstance).TotalSeconds:F3} MidiPlayerGlobal - DicAudioWave.Init");

                    DicAudioClip.Init();
                    if (verboseGlobal)
                        Debug.Log(
                            $"{(DateTime.Now - startInstance).TotalSeconds:F3} MidiPlayerGlobal - DicAudioClip.Init");
                }
                catch (Exception ex)
                {
                    ErrorDetail(ex);
                ...
                {
                    Debug.LogWarning(ErrorNoMidiFile);
                    yield return Routine.WaitForOneFrame;
                }
                else if (CurrentMidiSet.ActiveSounFontInfo == null)
                {
                    Debug.LogWarning(ErrorNoSoundFont);
                    yield return Routine.WaitForOneFrame;
                }

                if (verboseGlobal)
                    Debug.Log($"{(DateTime.Now - startInstance).TotalSeconds:F3} MidiPlayerGlobal - WaitForOneFrame");

                BuildMidiList();
                if (verboseGlobal)
                    Debug.Log($"{(DateTime.Now - startInstance).TotalSeconds:F3} MidiPlayerGlobal - BuildMidiList ");

                if (MPTK_LoadSoundFontAtStartup)
                    LoadCurrentSF();
                if (verboseGlobal)
                    Debug.Log($"{(DateTime.Now - startInstance).TotalSeconds:F3} MidiPlayerGlobal - LoadCurrentSF ");
            }
        }
        ...
        {
            var synths = FindObjectsByType<MidiSynth>(FindObjectsSortMode.None);
            if (synths != null)
                foreach (var synth in synths)
                {
                    if (synth is MidiFilePlayer)
                    {
                        var player = (MidiFilePlayer)synth;
                        if (player.MPTK_IsPlaying) player.MPTK_Stop(); // stop and clear all sound
                    }
        ...
        /// <summary>
        ///     @brief
        ///     @warning MPTK_IsReady has been deprecated, please investigate MPTK_Pulse in place
        ///     <midiSynth>
        ///         .MPTK_SoundFont.IsReady
        ///         @code
        ...
        {
            Debug.LogWarning(
                "MPTK_IsReady has been deprecated, please investigate <midiSynth>.MPTK_SoundFont.IsReady in place.");
            return true;
        }
        ...
        ///     Note 1: this call doesn't change the current MIDI bank used to play an instrument, only the content of
        ///     #MPTK_ListPreset.\n
        ...
        ///     Note 1: this call doesn't change the current MIDI bank used to play a drum, only the content of
        ///     #MPTK_ListPresetDrum.\n
        ///     Note 2: to apply the bank to all channels, the synth must be restarted: call MidiFilePlayer.MPTK_InitSynth.\n
        ///     Note 3: to change the current bank, rather use MidiFilePlayer.MPTK_ChannelPresetChange\n
        /// </summary>
                ...
                if (ImSFCurrent != null && ImSFCurrent.Banks != null)
                    if (bank >= 0 && bank < ImSFCurrent.Banks.Length && ImSFCurrent.Banks[bank] != null)
                        if (ImSFCurrent.Banks[bank].defpresets != null)
                            if (patch >= 0 && patch < ImSFCurrent.Banks[bank].defpresets.Length &&
                                ImSFCurrent.Banks[bank].defpresets[patch] != null)
        ...
        private static IEnumerator<float> LoadSoundFontThread(bool restartPlayer = true)
        {
            //if (MidiPlayerGlobal.ImSFCurrent != null)
            {
                ...
                var synths = FindObjectsByType<MidiSynth>(FindObjectsSortMode.None);
                var playerToRestart = new List<MidiFilePlayer>();
                        ...
                        foreach (var synth in synths)
                        {
                            ...
                            if (Application.isPlaying)
                                yield return Routine.WaitUntilDone(
                                    Routine.RunCoroutine(synth.ThreadWaitAllStop(), Segment.RealtimeUpdate), false);
                            else
                                yield return Routine.WaitUntilDone(
                                    Routine.RunCoroutine(synth.ThreadWaitAllStop(), Segment.EditorUpdate), false);
                            synth.MPTK_StopSynth();
                        }
                ...
                if (Application.isPlaying)
                    if (playerToRestart != null)
                        foreach (var synth in playerToRestart)
                            if (synths != null)
                                synth.MPTK_RePlay();
            }
        }
        ...
        private static void LoadSoundFont()
        {
            if (ImSFCurrent != null)
            {
                Debug.Log("Load MidiPlayerGlobal.ImSFCurrent: " + ImSFCurrent.SoundFontName);
                Debug.Log("Load CurrentMidiSet.ActiveSounFontInfo: " + CurrentMidiSet.ActiveSounFontInfo.Name);

                LoadCurrentSF();
                Debug.Log("Time To Load SoundFont: " + Math.Round(MPTK_TimeToLoadSoundFont.TotalSeconds, 3) +
                          " second");
                if (Application.isPlaying)
                    Debug.Log("Time To Load Samples: " + Math.Round(MPTK_TimeToLoadWave.TotalSeconds, 3) + " second");
            }
        }
        ...
        public static void LoadCurrentSF()
        {
            ...
            try
            {
                if (CurrentMidiSet == null)
                {
                    Debug.Log(ErrorNoSoundFont);
                }
                else
                {
                    var sfi = CurrentMidiSet.ActiveSounFontInfo;
                    if (sfi == null)
                    {
                        Debug.LogWarning(ErrorNoSoundFont);
                    }
                    else
                    {
                        ...
                        var pathToImSF = Path.Combine(SoundfontsDB + "/", sfi.Name);
                        ...
                        if (VerboseGlobal)
                            Debug.Log($"{(DateTime.Now - start).TotalSeconds:F3} ImSoundFont.LoadMPTKSoundFont");
            ...
            //if (Application.isPlaying) // check removes in v2.89.5
            {
                try
                {
                    ...
                    var watchLoadWave = new Stopwatch(); // High resolution time
                    watchLoadWave.Start();
                    ...
                    if (MPTK_LoadSoundFontAtStartup)
                    {
                        LoadWave();
                        if (VerboseGlobal)
                            Debug.Log($"Load DicAudioWave {(DateTime.Now - start).TotalSeconds:F3} second");
                        if (Application.isPlaying && !DicAudioWave.Check())
                            Debug.LogError(
                                $"<color=red>No sample found in the SoundFont {CurrentMidiSet.ActiveSounFontInfo.Name}. Have you extracted samples from the Maestro 'SoundFont Setup' menu in Unity Editor?</color>");
                    }
#else
        ...
        private static void LoadAudioClip()
        {
            try
            {
                ...
                if (ImSFCurrent != null)
                {
                    foreach (var smpl in ImSFCurrent.HiSf.Samples)
                        if (smpl.Name != null)
                            if (!DicAudioClip.Exist(smpl.Name))
                            {
                                var path = WavePath + "/" + Path.GetFileNameWithoutExtension(smpl.Name); // + ".wav";
        ...
        private static void LoadWave()
        {
            try
            {
                if (ImSFCurrent != null)
                {
                    foreach (var hiSample in ImSFCurrent.HiSf.Samples)
        ...
        public static void LoadWave(HiSample smpl)
        {
            ...
            {
                var data = new float[ac.samples * ac.channels];
        ...
        public static void BuildBankList()
        {
            ...
            try
            {
                ...
                if (ImSFCurrent != null && CurrentMidiSet != null)
                    foreach (var bank in ImSFCurrent.Banks)
                        if (bank != null)
                        {
        ...
        public static void BuildPresetList(bool forInstrument)
        {
            ...
            try
            {
                ...
                if (ImSFCurrent != null)
                {
                    if ((forInstrument && ImSFCurrent.DefaultBankNumber >= 0 &&
                         ImSFCurrent.DefaultBankNumber < ImSFCurrent.Banks.Length) ||
                        (!forInstrument && ImSFCurrent.DrumKitBankNumber >= 0 &&
                         ImSFCurrent.DrumKitBankNumber < ImSFCurrent.Banks.Length))
                    {
                        var ibank = forInstrument ? ImSFCurrent.DefaultBankNumber : ImSFCurrent.DrumKitBankNumber;
                        if (ImSFCurrent.Banks[ibank] != null)
                        {
                            ImSFCurrent.Banks[ibank].PatchCount = 0;
                            for (var ipreset = 0; ipreset < ImSFCurrent.Banks[ibank].defpresets.Length; ipreset++)
                            {
                                var p = ImSFCurrent.Banks[ibank].defpresets[ipreset];
                                if (p != null)
                                {
                                    var label = $"{p.Num} - {p.Name}";
                                    presets.Add(new MPTKListItem
                                        { Index = p.Num, Label = label, Position = presets.Count });
                        ...
                        {
                            Debug.LogWarningFormat("Default bank {0} for {1} is not defined.", ibank,
                                forInstrument ? "Instrument" : "Drum");
                        }
                    }
                    else
                    {
                        Debug.LogWarningFormat("No default bank defined for {0}.",
                            forInstrument ? "Instrument" : "Drum");
                    }
                    ...
                    foreach (var bank in ImSFCurrent.Banks)
                        ...
                        {
                            bank.PatchCount = 0;
                            foreach (var preset in bank.defpresets)
                                if (preset != null)
                                    // Bank count
                                    bank.PatchCount++;
        ...
        public static void BuildMidiList()
        {
            ...
            if (CurrentMidiSet != null && CurrentMidiSet.MidiFiles != null)
                foreach (var name in CurrentMidiSet.MidiFiles)
                    MPTK_ListMidi.Add(new MPTKListItem
                        { Index = MPTK_ListMidi.Count, Label = name, Position = MPTK_ListMidi.Count });
        ...
        private static void LoadMidiSetFromRsc()
        {
            try
            {
                var sf = Resources.Load<TextAsset>(FilenameMidiSet);
                if (sf == null)
                    Debug.LogWarning(ErrorNoMidiFile);
                else
        ...
        public void EndLoadingSF()
        {
            ...
            Debug.Log("   Time To Load SoundFont: " + Math.Round(MPTK_TimeToLoadSoundFont.TotalSeconds, 3) + " second");
            Debug.Log("   Time To Load Samples: " + Math.Round(MPTK_TimeToLoadWave.TotalSeconds, 3) + " second");
            Debug.Log("   Presets Loaded: " + MPTK_CountPresetLoaded);
            Debug.Log("   Samples Loaded: " + MPTK_CountWaveLoaded);
        }
