...
namespace LiteWater
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        private readonly Dictionary<Camera, Camera> m_ReflectionCameras = new(); // Camera -> Camera table
        private RenderTexture m_ReflectionTexture;
        private readonly Dictionary<Camera, Camera> m_RefractionCameras = new(); // Camera -> Camera table
        ...
        private void OnDisable()
        {
            ...
            foreach (var kvp in m_ReflectionCameras) DestroyImmediate(kvp.Value.gameObject);
            m_ReflectionCameras.Clear();
            foreach (var kvp in m_RefractionCameras) DestroyImmediate(kvp.Value.gameObject);
        ...
        {
            if (m_HardwareWaterSupport < waterMode) return m_HardwareWaterSupport;
            return waterMode;
        }
        ...
        private WaterMode FindHardwareWaterSupport()
        {
            ...
            if (mode == "Refractive") return WaterMode.Refractive;
            if (mode == "Reflective") return WaterMode.Reflective;
