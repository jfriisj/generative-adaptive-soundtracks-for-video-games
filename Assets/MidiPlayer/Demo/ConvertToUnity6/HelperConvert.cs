...
public class MPTK_Unity6_Helper
{
    ...
    private static void ManualConversionMenu()
    {
        ...
        {
            Debug.LogWarning(
                "Within 'Render Pipeline Converter' select all 'converters' and click 'Initialize And Convert' *** irreversible changes ***");
        ...
        {
            Debug.LogWarning(
                "Within 'Project Settings' search for 'Configuration/Active Input Handling' and select 'Both'");
            Debug.Log("More information here https://paxstellar.fr/news/");
