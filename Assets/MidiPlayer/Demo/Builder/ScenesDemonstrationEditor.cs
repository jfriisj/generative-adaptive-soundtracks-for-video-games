...
namespace MidiPlayerTK
{
    ...
    {
        private static ScenesDemonstrationEditor window;
        ...
        public void OnEnable()
        {
            ...
            loadedDemos.Root = rootVisualElement;

            // Load the UXML document from Assets/MidiPlayer/Demo/Builder/Resources
            var visualTree =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                    "Assets/MidiPlayer/Demo/Builder/Resources/ScenesDemonstration.uxml");
            ...
            loadedDemos.RowTemplate =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                    "Assets/MidiPlayer/Demo/Builder/Resources/OneRowDemo.uxml");

            var index = 1;
            foreach (var demo in loadedDemos.Demos) loadedDemos.AddRow(demo, index++, 0);
        }
