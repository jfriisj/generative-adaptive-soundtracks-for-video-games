...
namespace DemoMPTK
{
    public class HelperDemo
    {
        ...
        public static void DisplayInfoSynth(MidiSynth synth, int width, CustomStyle myStyle)
        {
            var infoSynth = synth.synthInfo.MPTK_BuildInfoSynth(synth);
            ...
            var rectLabel = GUILayoutUtility.GetLastRect();
        ...
        public static int CountVertical;
        ...
        public static void GUI_EffectSoundFont(float indent, MPTKEffectSoundFont effectSF)
        {
...
#else
            GUILayout.Label(
                "The effects of the soundfont are part of the design of each instrument. The designer carefully chose them to give the samples the best sound without too much emphasis, but as close as possible to the real sound.",
                myStyle.TitleLabel3);
            ...
            effectSF.EnableFilter =
                GUILayout.Toggle(effectSF.EnableFilter, "Enable Low Pass Filter", GUILayout.Width(155));
#if MPTK_PRO
            ...
            {
                effectSF.FilterFreqOffset =
 HelperDemo.GUI_Slider("      Offset Frequency (Hz):", effectSF.FilterFreqOffset, -1000, 3000, false, true, 1, widthCaption, widthSlider, widthLabelValue);
                effectSF.FilterQModOffset =
 HelperDemo.GUI_Slider("      Offset Quality Factor:", effectSF.FilterQModOffset, -30, 30, false, true, 1, widthCaption, widthSlider, widthLabelValue);
            }
#else
            GUI_Horizontal(Zone.END);
#endif
            ...
            {
                effectSF.ReverbAmplify =
 HelperDemo.GUI_Slider("      Offset Send SF Default:", effectSF.ReverbAmplify, -1, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectSF.ReverbLevel =
 HelperDemo.GUI_Slider("      Level:", effectSF.ReverbLevel, 0, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectSF.ReverbRoomSize =
 HelperDemo.GUI_Slider("      Room Size (s):", effectSF.ReverbRoomSize, 0, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectSF.ReverbDamp =
 HelperDemo.GUI_Slider("      Damp:", effectSF.ReverbDamp, 0, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectSF.ReverbWidth =
 HelperDemo.GUI_Slider("      Width:", effectSF.ReverbWidth, 0, 100, false, true, 1, widthCaption, widthSlider, widthLabelValue);
            }
#else
            GUI_Horizontal(Zone.END);
#endif
            ...
            {
                effectSF.ChorusAmplify =
 HelperDemo.GUI_Slider("      Offset Send SF Default:", effectSF.ChorusAmplify, -1, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectSF.ChorusLevel =
 HelperDemo.GUI_Slider("      Level:", effectSF.ChorusLevel, 0, 10, false, true, valueButton: 0.1f, widthCaption, widthSlider, widthLabelValue);
                effectSF.ChorusSpeed =
 HelperDemo.GUI_Slider("      Speed (Hz):", effectSF.ChorusSpeed, 0.1f, 5, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectSF.ChorusDepth =
 HelperDemo.GUI_Slider("      Depth:", effectSF.ChorusDepth, 0, 256, false, true, valueButton: 1, widthCaption, widthSlider, widthLabelValue);
                effectSF.ChorusWidth =
 HelperDemo.GUI_Slider("      Width:", effectSF.ChorusWidth, 0, 10, false, true, valueButton: 0.1f, widthCaption, widthSlider, widthLabelValue);
            }
#else
            GUI_Horizontal(Zone.END);
#endif
        ...
        static public void GUI_EffectUnity(float indent, MPTKEffectUnity effectUnity)
        {
            ...
            GUILayout.Space(10);
            GUI_Horizontal(Zone.BEGIN, null, GUILayout.ExpandWidth(false));
            effectUnity.EnableReverb =
 GUILayout.Toggle(effectUnity.EnableReverb, "Enable Reverb", GUILayout.Width(155));
            if (GUILayout.Button("Set Default Value", GUILayout.Width(150)))
                effectUnity.DefaultReverb();
            GUI_Horizontal(Zone.END);
            if (effectUnity.EnableReverb)
            {
                effectUnity.ReverbDryLevel =
 GUI_Slider("      Dry Level", effectUnity.ReverbDryLevel, 0, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectUnity.ReverbRoom =
 GUI_Slider("      Room Size", effectUnity.ReverbRoom, 0, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectUnity.ReverbDecayTime =
 GUI_Slider("      Decay Time (s)", effectUnity.ReverbDecayTime, 0.1f, 20, false, true, valueButton: 1f, widthCaption, widthSlider, widthLabelValue);
                effectUnity.ReverbLevel =
 GUI_Slider("      Level", effectUnity.ReverbLevel, 0, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectUnity.ReverbDelay =
 GUI_Slider("      Delay (s)", effectUnity.ReverbDelay, 0, 0.1f, false, true, valueButton: 0.001f, widthCaption, widthSlider, widthLabelValue);
                effectUnity.ReverbDiffusion =
 GUI_Slider("      Diffusion", effectUnity.ReverbDiffusion, 0, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectUnity.ReverbDensity =
 GUI_Slider("      Density", effectUnity.ReverbDensity, 0, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
            }

            GUILayout.Space(10);
            GUI_Horizontal(Zone.BEGIN, null, GUILayout.ExpandWidth(false));
            effectUnity.EnableChorus =
 GUILayout.Toggle(effectUnity.EnableChorus, "Enable Chorus", GUILayout.Width(155));
            if (GUILayout.Button("Set Default Value", GUILayout.Width(150)))
                effectUnity.DefaultChorus();
            GUI_Horizontal(Zone.END);
            if (effectUnity.EnableChorus)
            {
                effectUnity.ChorusDryMix =
 GUI_Slider("      Dry Level", effectUnity.ChorusDryMix, 0, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectUnity.ChorusDepth =
 GUI_Slider("      Chorus Depth", effectUnity.ChorusDepth, 0, 1, false, true, valueButton: 0.01f, widthCaption, widthSlider, widthLabelValue);
                effectUnity.ChorusRate =
 GUI_Slider("      Chorus Rate (Hz)", effectUnity.ChorusRate, 0, 20, false, true, valueButton: 0.1f, widthCaption, widthSlider, widthLabelValue);
                effectUnity.ChorusDelay =
 GUI_Slider("      Chorus Delay (ms)", effectUnity.ChorusDelay, 0, 100, false, true, valueButton: 1f, widthCaption, widthSlider, widthLabelValue);
            }
...
#else
        public static void GUI_EffectUnity(float indent)
        {
            GUI_Horizontal(Zone.BEGIN, myStyle.BacgDemosLight);
            GUI_Indent(indent);
            GUI_Vertical(Zone.BEGIN);
            GUILayout.Label("Unity effects applied to all instruments/presets playing in the Maestro Prefab.",
                myStyle.TitleLabel3);
        ...
        public static void GUI_Horizontal(Zone zone, GUIStyle style = null, params GUILayoutOption[] options)
        {
            if (zone == Zone.BEGIN)
            {
                if (style == null)
        ...
        public static void GUI_Vertical(Zone zone, GUIStyle style = null, params GUILayoutOption[] options)
        {
            if (zone == Zone.BEGIN)
            {
                if (style == null)
        ...
        public static void GUI_Indent(float indent)
        {
            // Indent the gui
        ...
        public static float GUI_Slider(string caption, float val, float min, float max, bool alignCaptionRight = false,
            bool enableButton = true, float valueButton = 1f, float widthCaption = 100, float widthSlider = 100,
            float widthLabelValue = 30)
        {
            float length = 0;
            ...
            if (!string.IsNullOrEmpty(caption) && widthCaption > 0f)
                GUILayout.Label(caption, alignCaptionRight ? myStyle.LabelRight : myStyle.LabelLeft,
                    GUILayout.Width(widthCaption), GUILayout.Height(25));

            if (widthLabelValue > 0f)
                GUILayout.Label(Math.Round(val, 3).ToString(), myStyle.LabelRight, GUILayout.Width(widthLabelValue),
                    GUILayout.Height(25));
            ...
            if (widthSlider > 0f)
                val = GUILayout.HorizontalSlider(val, min, max, myStyle.SliderBar, myStyle.SliderThumb,
                    GUILayout.Width(widthSlider));

            GUI_Horizontal(Zone.END);
            return val;
        }

        public static bool FoldOut(bool open, string title, string url = null)
        {
            GUI_Horizontal(Zone.BEGIN, null, GUILayout.ExpandWidth(false));
        ...
        public static void LinkTo(string url)
        {
        ...
        public static Vector3 GUIScale()
        {
            ...
            var scale = new Vector3(Screen.width / 1200f, Screen.height / 720f, 1.0f);
            // Match width
            scale.y = scale.x;
