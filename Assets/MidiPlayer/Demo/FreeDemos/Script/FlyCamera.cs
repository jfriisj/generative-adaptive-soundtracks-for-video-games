...
namespace DemoMPTK
{
    public class FlyCamera : MonoBehaviour
    {
        ...
        private Vector3
            lastMouse = new(Screen.width / 2, Screen.height / 2,
                0); // Kind of in the middle of the screen, rather than at the top (play).
        ...
        private Vector3 getDirection()
        {
            ...
            if (Input.GetKey(KeyCode.R)) p_Velocity += new Vector3(0, 1, 0);
            if (Input.GetKey(KeyCode.F)) p_Velocity += new Vector3(0, -1, 0);
            return p_Velocity;
        }
