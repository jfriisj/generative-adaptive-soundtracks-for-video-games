...
namespace DemoMPTK
{
    ...
    {
        private static Texture buttonIconHome;
        private static Texture buttonIconMPTK;
        private static Texture buttonIconQuit;
        private static Texture buttonIconHelp;
        ...
        public static void Display(string title, CustomStyle myStyle, float width, string helpUrl = null)
        {
            ...
            if (GUILayout.Button(new GUIContent(buttonIconHome, "Go to main menu"), GUILayout.Width(60),
                    GUILayout.Height(60)))
            ...
            if (GUILayout.Button(new GUIContent(buttonIconMPTK, "Go to web site"), GUILayout.Width(60),
                    GUILayout.Height(60)))
